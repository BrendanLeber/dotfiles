...
;;;     checksum        = "64694 2726 13964 133891",
...
(defconst isbn-version "1.16")		;NB: update this at every change
(defconst isbn-date "[24-Sep-2015]") 	;NB: update this at every change
(provide 'isbn)

;;; Change log:
;;; ====================================================================
;;; Version 1.16 [24-Sep-2015]
;;; Add 65 new ranges from 9-Apr-2004 snapshot on www.archive.org of
;;;     http://www.isbn.spk-berlin.de/html/prefix/prefs.htm
;;; The List-of-Ranges.pdf file (see below) is no longer available,
;;; and the last snapshot on www.archive.org of 27-Mar-2006 has only
;;; numeric ranges, without country/language identification.
;;;
...
countries, or new publisher assignments, or simply be in error."
  ...
  (while (and (or (null how-many) (> how-many 0))
    ...
    (cond
     ...
     ;; [24-Sep-2015] Updated list from
     ;; https://web.archive.org/web/20030210002752/http://isbn.spk-berlin.de/html/prefix/prefu.htm
     ((isbn-in-rangep "0-315" "0-315" ))
     ((isbn-in-rangep "0-458" "0-459" ))
     ((isbn-in-rangep "0-612" "0-612" ))
     ((isbn-in-rangep "0-616" "0-616" ))
     ((isbn-in-rangep "0-660" "0-660" ))
     ((isbn-in-rangep "0-662" "0-662" ))
     ((isbn-in-rangep "0-665" "0-665" ))
     ((isbn-in-rangep "0-7700" "0-7799" ))
     ((isbn-in-rangep "0-86488" "0-86507" ))
     ((isbn-in-rangep "0-88500" "0-88668" ))
     ((isbn-in-rangep "0-88750" "0-88999" ))
     ((isbn-in-rangep "0-919000" "0-921999" ))
     ((isbn-in-rangep "0-9680000" "0-9699999" ))
     ((isbn-in-rangep "0-9730000" "0-9739999" ))
     ;; ----------------------------------------------------------------
     ...
     ;; [24-Sep-2015] Addition from
     ;; https://web.archive.org/web/20030210002752/http://isbn.spk-berlin.de/html/prefix/prefu.htm
     ((isbn-in-rangep "0-7021"      "0-7021"    ))
     ((isbn-in-rangep "0-7954"      "0-7973"    ))
     ((isbn-in-rangep "0-7975"      "0-7977"    ))
     ((isbn-in-rangep "0-7979"      "0-7998"    ))
     ...
     ;; [24-Sep-2015] Additions from
     ;; https://web.archive.org/web/20030210002752/http://isbn.spk-berlin.de/html/prefix/prefu.htm
     ((isbn-in-rangep "1-894000" "1-896999" ))
     ((isbn-in-rangep "1-897000" "1-897579" ))
     ;; ----------------------------------------------------------------
     ;; Region name:     Gibraltar
     ;; Country code(s): GI
     ;; Language group:  1
     ...
     ;; [24-Sep-2015] Additions from
     ;; https://web.archive.org/web/20030210002752/http://isbn.spk-berlin.de/html/prefix/prefu.htm
     ((isbn-in-rangep "1-4150"      "1-4154"    ))
     ((isbn-in-rangep "1-77000"     "1-77019"   ))
     ...
     ;; [24-Sep-2015] Updated list from
     ;; https://web.archive.org/web/20030210002752/http://isbn.spk-berlin.de/html/prefix/prefu.htm
     ((isbn-in-rangep "1-4050" "1-4099" ))
     ((isbn-in-rangep "1-84000" "1-85122" ))
     ((isbn-in-rangep "1-85124" "1-86249" ))
     ((isbn-in-rangep "1-869800" "1-871030" ))
     ((isbn-in-rangep "1-871032" "1-874799" ))
     ((isbn-in-rangep "1-897580" "1-919654" ))
     ((isbn-in-rangep "1-952246" "1-952246" ))
     ((isbn-in-rangep "1-987807" "1-987807" ))
     ...
     ;; [24-Sep-2015] Updated list from
     ;; https://web.archive.org/web/20030210002752/http://isbn.spk-berlin.de/html/prefix/prefu.htm
     ((isbn-in-rangep "1-4000" "1-4049" ))
     ((isbn-in-rangep "1-4100" "1-4149" ))
     ((isbn-in-rangep "1-55500" "1-59999" ))
     ((isbn-in-rangep "1-871031" "1-871031" ))
     ((isbn-in-rangep "1-877580" "1-897579" ))
     ((isbn-in-rangep "1-928530" "1-952245" ))
     ((isbn-in-rangep "1-952247" "1-987806" ))
     ((isbn-in-rangep "1-987808" "1-998999" ))
     ;; ----------------------------------------------------------------
     ;; Region name:     Zimbabwe
     ;; Country code(s): ZW
     ;; Language group:  1
     ...
     ;; [24-Sep-2015] Updates from
     ;; https://web.archive.org/web/20030210002752/http://isbn.spk-berlin.de/html/prefix/prefu.htm
     ((isbn-in-rangep "3-7300"      "3-8499"    ))
     ((isbn-in-rangep "3-86000"     "3-89999"   ))
     ...
     ;; [24-Sep-2015] Updates from
     ;; https://web.archive.org/web/20030210002752/http://isbn.spk-berlin.de/html/prefix/prefu.htm
     ((isbn-in-rangep "3-9700000"   "3-9999999" ))
     ...
     ;; [24-Sep-2015] Additions from
     ;; https://web.archive.org/web/20150801000000*/http://www.isbn-international.org/en/identifiers/List-of-Ranges.pdf
     ((isbn-in-rangep "1-869800"     "1-998999" ))
     ...
     ;; [24-Sep-2015] Additions from
     ;; https://web.archive.org/web/20150801000000*/http://www.isbn-international.org/en/identifiers/List-of-Ranges.pdf
     ;; No country/language identification is available

     ((isbn-in-rangep "99947-0" "99947-2"       ))
     ((isbn-in-rangep "99947-30" "99947-69"     ))
     ((isbn-in-rangep "99947-700" "99947-999"   ))
     ((isbn-in-rangep "99948-0" "99948-4"       ))
     ((isbn-in-rangep "99948-50" "99948-79"     ))
     ((isbn-in-rangep "99948-800" "99948-999"   ))
     ((isbn-in-rangep "99949-0" "99949-1"       ))
     ((isbn-in-rangep "99949-20" "99949-89"     ))
     ((isbn-in-rangep "99949-900" "99949-999"   ))
     ((isbn-in-rangep "99950-0" "99950-4"       ))
     ((isbn-in-rangep "99950-50" "99950-79"     ))
     ((isbn-in-rangep "99950-800" "99950-999"   ))
     ((isbn-in-rangep "99952-0" "99952-4"       ))
     ((isbn-in-rangep "99952-50" "99952-79"     ))
     ((isbn-in-rangep "99952-800" "99952-999"   ))
     ((isbn-in-rangep "99953-0" "99953-2"       ))
     ((isbn-in-rangep "99953-30" "99953-79"     ))
     ((isbn-in-rangep "99953-800" "99953-999"   ))
     ((isbn-in-rangep "99954-0" "99954-2"       ))
     ((isbn-in-rangep "99954-30" "99954-69"     ))
     ((isbn-in-rangep "99954-700" "99954-999"   ))
